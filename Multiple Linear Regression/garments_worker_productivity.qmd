...
The dataset has 691 complete cases and 506 missing observations in the work in progress variable. Therefore, these values will be filled using the predictive mean matching method.
